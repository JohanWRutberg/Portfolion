        ...
        <div className="flex flex-col w-full max-w-[700px]">
          ...
          >
            ...
            <div className="flex gap-x-6 w-full">
              <input type="text" placeholder="namn" className="input" />
              <input type="text" placeholder="e-post" className="input" />
            </div>
            <input type="text" placeholder="ämne" className="input" />
            <textarea placeholder="meddelande" className="textarea"></textarea>
            <button
