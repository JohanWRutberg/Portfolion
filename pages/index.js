  ...
  return (
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div
          className="text-center flex flex-col justify-center xl:pt-40 xl:text-left xl:ml-24
        ...
        >
          ...
          <motion.h1
            ...
            animate="show"
            exit="hidden"
            className="h1 mt-[52vh] lg:mt-0 max-w-sm xl:max-w-2xl mx-auto xl:mx-0 mb-10 xl:mb-16 bg-white/10 backdrop-blur-sm auto rounded-3xl p-4"
          >
